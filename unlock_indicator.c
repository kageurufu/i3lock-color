...
extern char textattemptscolor[9];
...
xcb_pixmap_t draw_image(uint32_t *resolution) {
    ...
    char strgroupsx[4][3] = {{textattemptscolor[0], textattemptscolor[1], '\0'},
                             {textattemptscolor[2], textattemptscolor[3], '\0'},
                             {textattemptscolor[4], textattemptscolor[5], '\0'},
                             {textattemptscolor[6], textattemptscolor[7], '\0'}};
    uint32_t textattempts16[4] = {(strtol(strgroupsx[0], NULL, 16)),
                               (strtol(strgroupsx[1], NULL, 16)),
                               (strtol(strgroupsx[2], NULL, 16)),
                               (strtol(strgroupsx[3], NULL, 16))};
        ...
        switch (pam_state) {
            ...
            default:
                if (show_failed_attempts && failed_attempts > 0) {
                    ...
                    cairo_set_source_rgba(ctx, (double)textattempts16[0]/255, (double)textattempts16[1]/255, (double)textattempts16[2]/255, (double)textattempts16[3]/255);
